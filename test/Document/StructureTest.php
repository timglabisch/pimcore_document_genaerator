...
class tl extends PHPUnit_Framework_TestCase {
    ...
    function testBlock() {
        $c = new Pimcore_Document_Structure();
        $tag = $c->addTag('_ROOT-BLOCK3_')->addTag('_ROOT-BLOCK3-BLOCK4_')->addTag('_ROOT-BLOCK3-BLOCK4-BLOCK5_')->addTag('_ROOT-BLOCK3-BLOCK4-INP1_', null, Pimcore_Document_Structure::NTH_NEXT);
        $this->assertEquals(
