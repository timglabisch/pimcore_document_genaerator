...
class tl extends PHPUnit_Framework_TestCase {
    ...
    function testSibling1() {
        ...
        $tag = $c->addTag('_ROOT-BLOCK3_')->addTag('_ROOT-BLOCK3-BLOCK4_')->addTag('_ROOT-BLOCK3-BLOCK4-BLOCK5_')->addTag('_ROOT-BLOCK3-BLOCK4-INP2_');
        $this->assertEquals(
            '_NEXT TO__ROOT-BLOCK3___ROOT-BLOCK3-BLOCK4__ROOT-BLOCK3_1__ROOT-BLOCK3-BLOCK4-BLOCK5__ROOT-BLOCK3___ROOT-BLOCK3-BLOCK4__ROOT-BLOCK3_11_1__ROOT-BLOCK3-BLOCK4-INP2__ROOT-BLOCK3___ROOT-BLOCK3-BLOCK4__ROOT-BLOCK3_1__ROOT-BLOCK3-BLOCK4-BLOCK5__ROOT-BLOCK3___ROOT-BLOCK3-BLOCK4__ROOT-BLOCK3_11_11_1_11_1_1',
            $tag->addSibling('_NEXT TO_')->getName()
        );
    }
}